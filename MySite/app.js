...
let fullName = document.getElementsByClassName("txtb")[0];
let warningTimeout;
warningBox = document.createElement("div");
warningBox.className = "warning";

let displayWarning = msg => {
    ...
    if (document.body.contains(warningBox)) {
        ...
        fullName.parentNode.insertBefore(warningBox, fullName);
    }
...
fullName.addEventListener('keypress', checkName, false);
